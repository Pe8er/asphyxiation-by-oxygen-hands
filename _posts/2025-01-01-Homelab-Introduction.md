...
1. [Miscellaneous Setup (networking, external drive mounting, etc.)](/Homelab-Misc-Setup)
2. [Installing Apps](/Homelab-Installing-Apps)
3. [Plex Media Server](/Homelab-Plex)
4. [Calibre Web](/Homelab-Calibre)
5. [Reducing External Hard Drive Noise](/Homelab-HDD-Noise)
6. [Homelab: Moving Raspberry OS to a larger SD Card](/Homelab-Moving-SD)