...
This procedure was scary and felt like stumbling around a maze in a blindfold. Borg is way too powerful and customizable for my needs, although I think it works. We'll see.

*Update several months later: it works!!*
...
repositories:
    - path: ssh://u478712@u478712.your-storagebox.de:23/./backups/g3
...
exclude_patterns:
    ...
    - /home/pe8er/Movies
    - /home/pe8er/TV
    - "/home/pe8er/emulation/roms/Microsoft - Xbox 360"
    - "/home/pe8er/emulation/roms/Nintendo - Switch"
    - "/home/pe8er/emulation/roms/Sony - Playstation 2"
    - "/home/pe8er/emulation/roms/Sony - Playstation 3"
    - "/home/pe8er/emulation/roms/Sony - Playstation 4"
    - /home/pe8er/snap
    - "*/*tmp"
    - "*/log"
    - "*/logs"
...
ntfy:
    ...
    finish:
        ...
        priority: min
    fail:
        title: "Borgmatic Error: {repository}"
        message: "{output}"
...
#     - after: error
#       run:
#           - echo "Backup failed! Ensuring containers are back up..."
#           - docker ps -a -q | xargs -r docker start
```
...
[Timer]
OnCalendar=*-*-* 4:00:00/2 # runs every other day
Persistent=true
